...
if(isset($_POST['update'])){
 ...
 // teams and results
 $teams = [
   ['name' => $team1, 'teamCountryCode' => $team1CountryCode, 'result' => $team1Result],
   ['name' => $team2, 'teamCountryCode' => $team2CountryCode, 'result' => $team2Result]
 ...
 $sqlEventResult = "INSERT INTO `event_result`(`teamResult`, `winner`, `goals`, `yellowCards`, `redCards`) VALUES ('{$team['teamResult']}','{$winner}','{$goals}','{$yellowCards}','{$redCards}')";
